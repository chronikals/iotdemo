<!-- Button Builder Example -->
    ...
    $(function () {
        ...
        $('#btn-colors button').on('click', function (e) {
            $('#buttonIconLight a').removeClass('btn-default btn-primary btn-link btn-branding btn-red btn-ghost').addClass($(this).val());
            show_result();
            show_color();
...
$(function () {
    ...
    $('#btn-colors button').on('click', function (e) {
        $('#buttonIconDark a').removeClass('btn-default-dark btn-primary-dark btn-link-dark  btn-branding btn-red-dark btn-ghost-dark').addClass($(this).val() + '-dark');
        show_result();
    });
